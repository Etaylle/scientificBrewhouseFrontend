...
export default function BlogDetailWrapper() {
  ...
  // Für "Fertige Biere": Nur Header verwenden, dann eigenes Full-Width Layout
  if (isFinishedBeer) {
    return (
      <div className="min-h-screen bg-background transition-colors duration-300">
        {/* Nur den Header vom Layout übernehmen */}
        ...
        {/* Full-Width Content für Fertige Biere */}
        <BlogDetail post={post} />
      </div>
    );
  }

  // Standard Layout für andere Kategorien
  return (
    <BrewhouseLayout>
      <BlogDetail post={post} />
    </BrewhouseLayout>
