...
function Switch({
  ...
  return (
    <SwitchPrimitive
      ...
      className={cn(
          'relative flex p-[4px] h-8 w-14 shrink-0 cursor-pointer items-center rounded-full transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:cursor-not-allowed disabled:opacity-50 data-[checked]:bg-muted bg-muted hover:bg-accent dark:hover:bg-accent data-[checked]:justify-end justify-start',
          className,
      )}
      as={as}
      whileTap="tap"
    ...
    >
      ...
      <motion.span
        ...
        whileTap="tab"
        className={cn(
            'relative z-[1] flex items-center justify-center rounded-full bg-foreground text-background shadow-lg ring-0'
        )}
        layout
